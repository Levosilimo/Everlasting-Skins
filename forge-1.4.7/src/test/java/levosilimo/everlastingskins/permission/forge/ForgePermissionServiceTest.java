...
/**
 * 1.4.7 permission adapter tests.
 *
 ...
 * 1.4.7 ops model (there is no PermissionAPI / UserListOps on this line).
 * Player identity is the username-derived offline UUID bridge
 * ({@link SkinRestorer#uuidOf(String)}): 1.4.7 has no account UUID.
 */
public class ForgePermissionServiceTest {
    ...
    public void backendNameIsCorrect() {
        assertEquals("Forge ops (1.4.7)", new ForgePermissionService().getActiveBackendName());
    }
