...
public class NetworkMetricsHandler extends ChannelDuplexHandler {
    ...
    /** 1.20.1 delta: net.minecraft.network.HandlerNames is a 1.20.2+ addition. */
    ...
    public static NetworkMetricsHandler getOrAttach(Connection connection) {
        try {
            ...
            if (pipeline.get(ENCODER_HANDLER_NAME) != null) {
                pipeline.addBefore(ENCODER_HANDLER_NAME, HANDLER_NAME, handler);
            } else {
