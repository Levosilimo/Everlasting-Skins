// Standalone Gradle build for the Minecraft 1.18.2 Forge lane
...
// host this lane. It therefore has its own wrapper (Gradle 8.14, run on Java
...
//
// foojay resolver: the lane compiles with the Java 17 toolchain (Forge 40
...
rootProject.name = "everlastingskins-forge-1.18.2"
