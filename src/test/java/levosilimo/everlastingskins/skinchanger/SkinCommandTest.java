...
class SkinCommandTest {
    ...
    class TryRestoreFromMojang {
        ...
        void restoreFromStoredSource() {
            ...
            MojangRestoreResult result = SkinCommand.tryRestoreFromMojang(api, STORED_SOURCE, PLAYER_NAME);
        ...
        void fallbackFromNullSource() {
            ...
            MojangRestoreResult result = SkinCommand.tryRestoreFromMojang(api, null, PLAYER_NAME);
        ...
        void fallbackFromEmptySource() {
            ...
            MojangRestoreResult result = SkinCommand.tryRestoreFromMojang(api, "", PLAYER_NAME);
