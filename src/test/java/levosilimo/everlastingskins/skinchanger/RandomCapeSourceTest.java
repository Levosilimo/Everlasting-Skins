...
class RandomCapeSourceTest {
    ...
    class Limits {
        ...
        void respects_page_limit() throws Exception {
            ...
            assertTrue(containsUsername(bothPages, "Alice"));
            assertTrue(containsUsername(bothPages, "Bob"));
        }
    ...
    class RandomPick {
        ...
        void pick_returns_member_of_pool() throws Exception {
            ...
            assertTrue(Arrays.asList("A", "B", "C").contains(picked));
        }
    }
    ...
    private static boolean containsUsername(List<RandomCapeSource.CapeCandidate> candidates, String username) {
        for (RandomCapeSource.CapeCandidate candidate : candidates) {
    ...
    private static String fixture(String name) throws Exception {
        java.io.InputStream in = RandomCapeSourceTest.class.getResourceAsStream("/fixtures/mskins/" + name);
        if (in == null) {
    ...
    private static final class FakeCosmeticaApi extends CosmeticaApi {
        ...
        private final Map<String, CosmeticaPlayer> players = new HashMap<String, CosmeticaPlayer>();
