...
public class SkinIO {
    ...
    public int getSource(UUID uuid){
        ...
        if(FileUtils.readFile(savePath.resolve(uuid + FILE_EXTENSION).toFile())!=null){
            ...
            TextComponent msgText = new TextComponent("§6[EverlastingSkins]§f "+source);
            ...
            SkinRestorer.server.getPlayerList().getPlayer(uuid).sendMessage(msgText, Mth.createInsecureUUID());
        }
        return 1;
    }
