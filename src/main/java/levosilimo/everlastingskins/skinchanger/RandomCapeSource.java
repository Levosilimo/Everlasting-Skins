...
public class RandomCapeSource {
    ...
    public static final class CapeCandidate {

        private final String username;
        private final String capeTextureUrl;

        CapeCandidate(String username, String capeTextureUrl) {
            this.username = username;
            this.capeTextureUrl = capeTextureUrl;
        }
    ...
    public List<CapeCandidate> findCapeBearers() throws IOException {
        List<CapeCandidate> candidates = new ArrayList<CapeCandidate>();
