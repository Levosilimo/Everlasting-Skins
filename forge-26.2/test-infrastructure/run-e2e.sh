...
#             forked client JVM as -Deverlastingskins.e2e=true). The
#             unobfuscated 26.2 client Main joins via the quick play arg
#             --quickPlayMultiplayer <addr> (GameConfig$QuickPlayMultiplayerData
#             -> QuickPlay.connect -> joinMultiplayerWorld ->
#             ConnectScreen.startConnecting, bytecode-verified).
#   assert  — the in-jar E2EDriver (forge26.e2e, shipped in the mod jar)
