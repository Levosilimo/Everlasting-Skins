...
package levosilimo.everlastingskins.forge1710.util;
...
/**
 * i18n service for the 1.7.10 lane.
 *
 ...
 * then the raw key. The 1.7.10 server has no per-player locale surface
 * (that arrives with the 1.13+ client information packet), so lookups use
 * the server/admin language from {@link Config#LANGUAGE} only.
 */
