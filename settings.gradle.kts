...
//    forge-1.10.2/ (Gradle 4.10.3). forge-1.6.4/ and forge-1.5.2/ also
//    run Gradle 4.4.1 but have NO ForgeGradle at all — vendored
//    SpecialSource 1.7.4 deobf harness (GTNH FG 1.2.11 rejects forge
//    9.11.1.1345 at configuration time and its support envelope does
//    not reach forge 7.8.1.738; no MCP 1.6.4 / 1.5.2 channel exists).
