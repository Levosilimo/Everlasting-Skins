...
public class EverlastingSkins {
    ...
    /**
     * ModLoadingContext.get() is deprecated-for-removal in Forge 47 but is
     * the only way to register a ModConfig.Type.COMMON config in 1.20.1
     * (the official 47.x MDK ships this exact call); the -Werror gate
     * therefore needs this targeted suppression.
     */
