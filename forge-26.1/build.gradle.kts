// forge-26.1 lane (Minecraft 26.1, Forge 62.0.9, Java 25, unobfuscated MC).
// Mirror of forge-26.2/build.gradle.kts: all versioning lives in
...
// Pinned to 7.0.1, the 26.1-era EventBus version (memory #1279) — NOT 7.0.5,
// which is the version the 26.2-65.0.9 MDK ships.
dependencies {
...
minecraft {
    runs {
        configureEach {
            ...
            // The 26.1 skin application swaps the player's GameProfile via
