 ...
 *
 * <p>26.1 deltas vs the 1.21 reference:
 * <ul>
 ...
 *       addListener path).</li>
 *   <li>{@code Minecraft.screen} — 26.1 still carries the active screen as
 *       a field on {@code Minecraft} (26.2 moved it onto {@code Gui}; this
 *       port targets 26.1).</li>
...
public final class E2EDriver {
    ...
    private static String texturesProperty(Minecraft mc) {
        ...
        // authlib 7: GameProfile is a record (properties() accessor);
    ...
    private static void writeResultAndExit(int exitCode, boolean joined, boolean commandSent,
        ...
        try {
            ...
            artifacts.put("driver", "E2EDriver/26.1");
