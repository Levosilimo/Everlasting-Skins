...
/**
 * 1.5.2 permission adapter tests.
 *
 ...
 * 1.5.2 ops model (there is no PermissionAPI / UserListOps on this line).
 * Player identity is the username-derived offline UUID bridge
 * ({@link SkinRestorer#uuidOf(String)}): 1.5.2 has no account UUID.
 */
public class ForgePermissionServiceTest {
    ...
    public void backendNameIsCorrect() {
        assertEquals("Forge ops (1.5.2)", new ForgePermissionService().getActiveBackendName());
    }
