...
/**
 * 1.5.2 permission adapter.
 *
 * <p>1.5.2 has no Forge PermissionAPI and no per-player permission-node
 ...
 * method 1.6.4/1.7.10 use). The shared {@code hasPermission(UUID, int, String)}
 ...
 *
 * <p>Skin storage is keyed by UUID only (memory #1123), and 1.5.2 has no
 ...
 * derived UUID; 1.5.2 has no {@code getPlayerByUUID} (func_152612_a is
 * 1.7.10+).
 *
...
public class ForgePermissionService implements IPermissionService {
    ...
    /** Required op level for a node (0 = any player, 2 = op), mirroring 1.6.4. */
