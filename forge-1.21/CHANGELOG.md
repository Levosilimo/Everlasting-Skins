...
## 2.1.0-rc.1 (2026-08-05) — Minecraft 1.21.8 port

First 1.21.8 point-release build of the 2.1.0-rc.1 feature set: identical code to the 1.21
build, re-targeted at Minecraft 1.21.8 / Forge 58.1.21 (ForgeGradle 7.0.x, Gradle 9.3.1).
