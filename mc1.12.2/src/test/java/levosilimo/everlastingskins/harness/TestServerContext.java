...
public class TestServerContext implements AutoCloseable {
    ...
    public TestServerContext(Path tempDir) {
        ...
        // Mirror production's EverlastingSkins.init(): register the vanilla
        // permission backend. :common's PermissionServiceManager is fail-closed
        // when nothing is registered (the old uninitialized-vanilla fallback
        // was removed with init()).
