...
public class CosmeticaApi {
    ...
    private static final Logger LOGGER = LogManager.getLogger(CosmeticaApi.class);
    ...
    public CosmeticaPlayer getPlayer(String nameOrUuid) {
        ...
        try {
            ...
            LOGGER.warn("Cosmetica lookup failed for {}: {}", nameOrUuid, e);
            return null;
        }
    }
    ...
    private static CosmeticaPlayer parseBodyOrNull(HttpResponse response) {
        try {
            ...
            LOGGER.warn("Failed to parse Cosmetica response: " + e);
            return null;
