...
public interface MojangAPI {
    ...
    /**
     * Source discriminator persisted with skins fetched from Mojang (moved
     * here from the per-version command layer so the HTTP impls can stay
     * pure-Java).
     */
    String SOURCE_MOJANG = "MojangAPI";
